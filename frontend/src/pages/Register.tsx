...
import { Mail, Lock, ArrowRight, LogIn, UserCheck, AlertCircle, CheckCircle2, ChevronLeft } from 'lucide-react';
        ...
        <AuthCard>
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-zinc-400 text-xs sm:text-sm font-normal">
              Register your email to start building with developer auth.
            </p>
          </div>
